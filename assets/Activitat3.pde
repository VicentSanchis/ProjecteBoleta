/**
* Activitat 3. Inicialització de les variables del projecte
* -------------------------------------------------------------------------------
* Una vegada ja tenim declarades les nostres primeres variables, les hem 
* d'inicialitzar, és a dir, donar-los un valor inicial.
